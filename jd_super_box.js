...
================Loon==============
[Script]
cron "24 3,13 * * *" script-path=jd_cjhz.js,tag=京东超级盒子

===============Surge=================
京东超级盒子 = type=cron,cronexp="24 3,13 * * *",wake-system=1,timeout=3600,script-path=jd_cjhz.js

============小火箭=========
京东超级盒子 = type=cron,script-path=jd_cjhz.js, cronexpr="24 3,13 * * *", timeout=3600, enable=true
 */
