...
let rebateCodes = ["SLI8zFT", "SIMHz54", "StIuUgG"]
...
rebateCodes = $.isNode() ? (process.env.FLCODE3 ? process.env.FLCODE3 : `${rebateCodes}`) : ($.getdata('FLCODE3') ? $.getdata('FLCODE3') : `${rebateCodes}`);
