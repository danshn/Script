...
!(async () => {
    ...
    let authorCode = []
    let res = await getAuthorShareCode('https://raw.githubusercontent.com/msechen/shareCodes/main/tiger.json')
    if (!res) {
        res = await getAuthorShareCode('https://raw.githubusercontent.com/msechen/shareCodes/main/tiger.json')
    }
    if (res) {
